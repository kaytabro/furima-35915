class Item < ApplicationRecord
  ...
  validates :price, numericality: { only_integer: true, message: "は、半角数字で入力して下さい" }
  validates :price, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999 ,　message: "は、¥300~¥9,999,999の間で入力して下さい" }
